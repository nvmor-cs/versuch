...
- **Pausen-Timer** startet automatisch nach jedem abgehakten Satz (Dauer einstellbar). Am Ende gibt es **genau ein** Signal, und die Entscheidung darüber fällt an einer einzigen Stelle – nativ, wo auch der Timer läuft: War die App die ganze Pause über offen, macht sie den Ton selbst (eine weiche Glocke), sonst übernimmt die Systemmeldung. Jede Pause bekommt dafür ein eigenes Merkmal, das beim Auslösen verbraucht wird; ein Signal einer abgebrochenen oder älteren Pause kann deshalb nicht mehr mitten im nächsten Satz aufschlagen
