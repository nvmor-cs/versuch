...
- **Pausen-Timer** startet automatisch nach jedem abgehakten Satz (Dauer einstellbar). Am Ende gibt es **genau ein** Signal: War die App die ganze Pause über offen, macht sie den Ton selbst (eine weiche Glocke) und nimmt die geplante Meldung zurück; war sie zwischendurch weg, übernimmt die Systemmeldung. So klingelt es nie zweimal
